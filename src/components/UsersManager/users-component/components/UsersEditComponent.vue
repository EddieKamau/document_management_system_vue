<template>
    <div class="main-section">
        <div class="create-item">
            ...
            <!-- input -->
            <div class="form-input item2"> <input type="text" v-model="userDetails.username"> </div>
                <!-- label -->
            <div class="form-label item3">First Name:</div>
            <!-- input -->
            <div class="form-input item4"> <input type="text" v-model="userDetails.first_name"> </div>
                <!-- label -->
            <div class="form-label item5">Last Name:</div>
            <!-- input -->
            <div class="form-input item6"> <input type="text" v-model="userDetails.last_name"> </div>
                <!-- label -->
            <div class="form-label item9">Email:</div>
            <!-- input -->
            <div class="form-input item10"> <input type="text" v-model="userDetails.email"> </div>
                <!-- label -->
    ...
    methods: {
        ...
        addPermission(lst){
            lst.forEach(element => {
                ...
                this.addPermission.length != 0 ? this.chosenPermissions.push(this.availablePermissions[avIndex]) : null
